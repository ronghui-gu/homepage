...
\date{Fall 2018}
\titlegraphic{\includegraphics[width=0.3\textwidth]{puzzle-pieces.jpg}}
...
\begin{frame}
\centerline{\includegraphics[width=0.6\textwidth]{hey-jude-flowchart.jpg}}
...
\newcommand{\token}[1]{\tikz \node [minimum height=17pt,draw,rounded corners=2pt,fill=yellow!30] {#1};}
...
\tikzset{every matrix/.style={matrix of math nodes,
         ...
         group/.style={ellipse,draw,fill=yellow!30,minimum height=2.7pc, inner sep=-5pt},
...
\begin{frame}[t]{Subset construction for $(a|b)^*abb$}
  \begin{tikzpicture}[nfastate/.style={state,inner sep=25pt,fill=yellow!30},
    initial text={}]
...
\def\st#1#2{\begin{tikzpicture}
    \node [fill=yellow!30,text width=9pt,text centered,inner sep=0pt,
