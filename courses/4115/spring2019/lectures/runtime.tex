...
\date{Fall 2018}
\titlegraphic{\includegraphics[width=0.4\textwidth]{running-clock.png}}
...
\frame{\partpage
\centerline{\includegraphics[width=0.5\textwidth]{trapeze.jpg}}
}
...
\part{Exceptions}
\frame{\partpage
\centerline{\includegraphics[width=0.5\textwidth]{panic-key.jpg}}
}
