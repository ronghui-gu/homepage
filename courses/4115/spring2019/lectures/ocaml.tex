...
\date{Fall 2018}
\titlegraphic{\includegraphics[width=0.35\textwidth]{caml-128x58.png}}
...
- : int -> int -> int = <fun>
# \type{(fun x -> (fun y -> (x+1) * y)) 3 5;;}
- : int = 20

# \type{let square = fun x -> x * x;;}
val square : int -> int = <fun>
# \type{square 5;;}
- : int = 25
# \type{let square x = x * x;; (* shorthand *)}
val square : int -> int = <fun>
# \type{square 6;;}
- : int = 36
\end{interactive}
...
- : int = 42
# \type{eval (Plus(Times(Lit(3), Lit(2)), Lit(1)));;}
- : int = 7
\end{interactive}
\end{frame}
