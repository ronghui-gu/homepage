...
Theorem while_continue : forall b c st st' s,
  ...
  s = SContinue.
Proof.
  intros. inversion H; subst; trivial.
Qed.  
...
Theorem while_stops_on_break : forall b c st st',
  ...
  (WHILE b DO c END) / st \\ SContinue / st'.
Proof.
  intros. eapply E_WhileTrueBreak; trivial.
Qed.
...
Proof.
  intros p b c st st' Heq He.
  induction He; inversion Heq; clear Heq; subst; intros; eauto.
  congruence.
Qed.
...
Proof.
  ...
  induction E1;
    intros s2 st2 E2; inversion E2; subst; auto; try congruence.
  - (* Seq *)
    eapply IHE1 in H1. destruct H1 as (_ & HF). inversion HF.
  - eapply IHE1_1 in H4.
    destruct H4 as (_ & HF). inversion HF.
  - (* E_Seq *)
  ...
  - (* E_WhileFalse, b1 evaluates to false *)
    eapply IHE1 in H6. destruct H6 as (HF & _).
    split; trivial.
  - (* E_WhileFalse, b1 evaluates to false *)
    eapply IHE1 in H3. destruct H3 as (_ & HF). inversion HF.
  - (* E_WhileFalse, b1 evaluates to false *)
    eapply IHE1_1 in H6.
    destruct H6 as (_ & HF). inversion HF.
  - (* E_WhileFalse, b1 evaluates to false *)
    assert (st' = st'0) as EQ1.
    { (* Proof of assertion *) eapply IHE1_1; eassumption. }
    subst st'0.
