...
(** The materials are borrwoed from the  _Software Foundations_ series. 
...
(** 1) To compile the lecture notes, first download the following files
    ...
    [ coq_makefile -f _CoqProject Coq_Lecture1_Basics.v Coq_Lecture2_Induction_List.v -o Makefile ]
...
From LF Require Export Coq_Lecture1_Basics.
...
(** For the [Require Export] to work, you first need to use
    ...
    [.c] file.  There are two ways to do it:
     ...
     - From the command line: 
       (assuming you've downloaded the _CoqProject File)
       Generate the Coq Makefile
       
       [coq_makefile -f _CoqProject Coq_Lecture1_Basics.v -o Makefile]
       
       
       Either

         [make Coq_Lecture1_Basics.vo]
    ...
    Unable to locate library Coq_Lecture1_Basics], a likely reason is
